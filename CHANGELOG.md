...
## [1.1.0](https://github.com/Yggdrasil-Labs/mealmate-web/compare/v1.0.0...v1.1.0) (2026-09-06)
...
* Phase 2 AI 智能录入菜品前端（对话抽屉 + composable） ([73dd1b3](https://github.com/Yggdrasil-Labs/mealmate-web/commit/73dd1b381424ac6448966433b6a37f36a8144833))
...
* **recipe:** 新增 AI 菜品录入抽屉组件及对话 composable ([be3b4fc](https://github.com/Yggdrasil-Labs/mealmate-web/commit/be3b4fcaec06fc353249ac676a1ee19df18a6a0c))
* **recipe:** 菜品库添加分页组件 ([3dcff92](https://github.com/Yggdrasil-Labs/mealmate-web/commit/3dcff92ad7d4f160605dcb6ceaa9c35422a04512))
* **recipe:** 菜品库页面集成 AI 录入按钮和抽屉 ([9becc2c](https://github.com/Yggdrasil-Labs/mealmate-web/commit/9becc2ce110bb78cdd2afad3d96310ed1770de38))
* **web:** Phase 4.1 SSE 流式输出前端支持 ([4048262](https://github.com/Yggdrasil-Labs/mealmate-web/commit/40482625aa3013c29163b2110b28149c85f6105b))
* **web:** 周计划页新增 AI 生成功能 ([c56f371](https://github.com/Yggdrasil-Labs/mealmate-web/commit/c56f3719fb2a138cc3116a98fef369e1eb359228))
* **web:** 新增 SSE 流式输出 composable 与 UI 改造 ([fcecea8](https://github.com/Yggdrasil-Labs/mealmate-web/commit/fcecea843e4b7f196b7359380ab4d51bc2888d31))
...
* **family:** 家庭画像数据展示中文化与空态优化 ([f5c2579](https://github.com/Yggdrasil-Labs/mealmate-web/commit/f5c257967da7b1c9dea9cb35ca46033a080ad0ca))
...
* **layout:** 移动端抽屉导航增加遮罩层 ([25c986f](https://github.com/Yggdrasil-Labs/mealmate-web/commit/25c986f8c43f71ff0ad430f25344f54d2b3a2934))
...
* **meal-plan:** 周计划网格列溢出修复与按钮对比度 ([f9c3c49](https://github.com/Yggdrasil-Labs/mealmate-web/commit/f9c3c49a6971962914f3b98d4dacd4eedcc232df))
...
* **recipe:** AI 录入抽屉移动端全宽适配 ([86a5607](https://github.com/Yggdrasil-Labs/mealmate-web/commit/86a5607962b5ad8e5b0a5fa0b241e93cc9f533ee))
* **recipe:** READY_TO_CONFIRM 后仍允许用户继续输入修正 ([92466f4](https://github.com/Yggdrasil-Labs/mealmate-web/commit/92466f4572ee607cf45db646065e2774b1a20751))
...
* **test:** 修复 2 个断言与实现不一致的单测 + gitignore 补 dist-tmp ([8482853](https://github.com/Yggdrasil-Labs/mealmate-web/commit/8482853304eecdfb09e106a90194a7ed64fe3dcf))
* **web:** 修复 SSE 流式请求路径和 Vite 代理超时配置 ([80c4065](https://github.com/Yggdrasil-Labs/mealmate-web/commit/80c4065d196c399ce671e38e11f6175141a45962))
* **web:** 修复 weekly-meal-plan 页面 ESLint 错误 ([f0e789d](https://github.com/Yggdrasil-Labs/mealmate-web/commit/f0e789da7bda3541660082f7d86ca8ff046fc081))
...
* **deps-dev:** 批量升级开发依赖 ([1071f1e](https://github.com/Yggdrasil-Labs/mealmate-web/commit/1071f1e96e44e7735a0896c4577ee5c46c82ffab))
